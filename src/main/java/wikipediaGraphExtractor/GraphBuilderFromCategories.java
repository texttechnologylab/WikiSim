...
public class GraphBuilderFromCategories {
	...
	public static void main(String[] args) throws JSONException, IOException, SQLException {
		...
		for(int i = 0;i<outputPaths.length;i++){
			...
			HashMap<String, List<WikipeidaWikidata>> languageWikidataMap=  Wiki.getWikipediaLinksByLanguagesForWikidataScienceCategory(qid);
