...
def visualize(similarity_file, out_root, type, dataset=None, show=True, matplotlib=True):
...
if __name__ == '__main__':
    if process_all:
        for similarity_file in similarity_files:
            ...
            try:
                visualize(similarity_file=similarity_file, out_root=similarity_root, type='gml', dataset=None, show=False, matplotlib=False)
            except IOError:
                pass
