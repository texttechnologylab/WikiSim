...
if __name__ == '__main__':
    if process_all:
        for similarity_file in ['deltaCON_personalized_rw_affinities.csv',
            ...
            try:
                visualize(similarity_file=similarity_file, out_folder=os.path.join('..', '..', 'output', 'oecd', 'gml'), dataset=None, show=False)
            except IOError:
                pass
            except Exception as e:
                print(e)
            try:
                visualize(similarity_file=similarity_file, out_folder=os.path.join('..', '..', 'output', 'oecd', 'fullgml'), dataset=None, show=False)
            except IOError:
                pass
            except Exception as e:
                print(e)
