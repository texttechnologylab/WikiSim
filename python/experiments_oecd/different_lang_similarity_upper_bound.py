...
if __name__ == '__main__':
    ...
    for similarity_file in similarity_files:
        try:
            compute_sampled_statistics(similarity_file=similarity_file, out_folder=os.path.join('..', '..', 'output', 'oecd', 'gml'), sample_size=sample_size, sample_relative=True)
        except IOError:
            pass
        # except Exception as e:
        #     print(e)
        try:
            compute_sampled_statistics(similarity_file=similarity_file, out_folder=os.path.join('..', '..', 'output', 'oecd', 'fullgml'), sample_size=sample_size, sample_relative=True)
        except IOError:
            pass
        # except Exception as e:
        #     print(e)
