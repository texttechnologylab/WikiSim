infolder=../../graphs/oecd/
outfolder=../../outputComplete/oecd/
...
nohup python3 -u ../experiments/compute_vertex_jacc_similarities_intersection_alldata.py ${infolder} ${outfolder} > compute_vertex_jacc_similarities_intersection_alldata.out &
