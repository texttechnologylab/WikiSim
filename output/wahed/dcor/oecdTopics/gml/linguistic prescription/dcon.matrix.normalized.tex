...
\begin{tabular}{rRRRRRR}
 &  \mcvert{en} & \mcvert{es} & \mcvert{fr} & \mcvert{it} & \mcvert{ja} & \mcvert{pt} \\
\mchori{en}  &  1.0  &  0.71  &  0.36  &  0.36  &  1.0  &  1.0 \\
\mchori{es}  &  0.71  &  1.0  &  0.33999999999999997  &  0.33999999999999997  &  0.71  &  0.71 \\
\mchori{fr}  &  0.36  &  0.33999999999999997  &  1.0  &  0.0  &  0.36  &  0.36 \\
\mchori{it}  &  0.36  &  0.33999999999999997  &  0.0  &  1.0  &  0.36  &  0.36 \\
\mchori{ja}  &  1.0  &  0.71  &  0.36  &  0.36  &  1.0  &  1.0 \\
\mchori{pt}  &  1.0  &  0.71  &  0.36  &  0.36  &  1.0  &  1.0 \\
\end{tabular}
};
\end{tikzpicture}
